...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.researchInterests'
        db.alter_column('cog_userprofile', 'researchInterests', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'UserProfile.researchKeywords'
        db.alter_column('cog_userprofile', 'researchKeywords', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'Collaborator.researchKeywords'
        db.alter_column('cog_collaborator', 'researchKeywords', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.researchInterests'
        db.alter_column('cog_userprofile', 'researchInterests', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'UserProfile.researchKeywords'
        db.alter_column('cog_userprofile', 'researchKeywords', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Collaborator.researchKeywords'
        db.alter_column('cog_collaborator', 'researchKeywords', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 17, 25, 28, 898895)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 17, 25, 28, 898780)'}),
