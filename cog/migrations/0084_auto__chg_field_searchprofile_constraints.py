...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SearchProfile.constraints'
        db.alter_column(u'cog_searchprofile', 'constraints', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'SearchProfile.constraints'
        db.alter_column(u'cog_searchprofile', 'constraints', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
