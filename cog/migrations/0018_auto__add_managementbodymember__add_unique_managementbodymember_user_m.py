...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ManagementBodyMember'
        db.create_table('cog_managementbodymember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('managementBody', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.ManagementBody'])),
        ))
        db.send_create_signal('cog', ['ManagementBodyMember'])

        # Adding unique constraint on 'ManagementBodyMember', fields ['user', 'managementBody']
        db.create_unique('cog_managementbodymember', ['user_id', 'managementBody_id'])

        # Adding model 'ManagementBody'
        db.create_table('cog_managementbody', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('termsOfReference', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal('cog', ['ManagementBody'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ManagementBodyMember', fields ['user', 'managementBody']
        db.delete_unique('cog_managementbodymember', ['user_id', 'managementBody_id'])

        # Deleting model 'ManagementBodyMember'
        db.delete_table('cog_managementbodymember')

        # Deleting model 'ManagementBody'
        db.delete_table('cog_managementbody')
