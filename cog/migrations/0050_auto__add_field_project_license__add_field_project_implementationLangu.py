...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cog_project', 'license', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Project.implementationLanguage'
        db.add_column('cog_project', 'implementationLanguage', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Project.bindingLanguage'
        db.add_column('cog_project', 'bindingLanguage', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Project.supportedPlatforms'
        db.add_column('cog_project', 'supportedPlatforms', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Project.externalDependencies'
        db.add_column('cog_project', 'externalDependencies', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.license'
        db.delete_column('cog_project', 'license')

        # Deleting field 'Project.implementationLanguage'
        db.delete_column('cog_project', 'implementationLanguage')

        # Deleting field 'Project.bindingLanguage'
        db.delete_column('cog_project', 'bindingLanguage')

        # Deleting field 'Project.supportedPlatforms'
        db.delete_column('cog_project', 'supportedPlatforms')

        # Deleting field 'Project.externalDependencies'
        db.delete_column('cog_project', 'externalDependencies')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 4, 21, 37, 599715)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 4, 21, 37, 599603)'}),
