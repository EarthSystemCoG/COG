...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.dataSearchEnabled'
        db.add_column(u'cog_project', 'dataSearchEnabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Project.long_name'
        db.alter_column(u'cog_project', 'long_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60))

    def backwards(self, orm):
        # Deleting field 'Project.dataSearchEnabled'
        db.delete_column(u'cog_project', 'dataSearchEnabled')


        # Changing field 'Project.long_name'
        db.alter_column(u'cog_project', 'long_name', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True))
    ...
    models = {
        ...
        'cog.project': {
            ...
            'long_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '60'}),
