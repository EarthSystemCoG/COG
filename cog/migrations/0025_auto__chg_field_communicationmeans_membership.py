...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cog_communicationmeans', 'membership', self.gf('django.db.models.fields.CharField')(max_length=50))
    def backwards(self, orm):

        # Changing field 'CommunicationMeans.membership'
        db.alter_column('cog_communicationmeans', 'membership', self.gf('django.db.models.fields.BooleanField')())
    models = {
        'auth.group': {
        ...
        'cog.communicationmeans': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membership': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
