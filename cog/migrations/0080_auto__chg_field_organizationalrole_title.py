...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrganizationalRole.title'
        db.alter_column(u'cog_organizationalrole', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'OrganizationalRole.title'
        db.alter_column(u'cog_organizationalrole', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
