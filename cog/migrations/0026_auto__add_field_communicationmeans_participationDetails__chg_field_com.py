...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommunicationMeans.participationDetails'
        db.add_column('cog_communicationmeans', 'participationDetails',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'CommunicationMeans.membership'
        db.alter_column('cog_communicationmeans', 'membership', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CommunicationMeans.frequency'
        db.alter_column('cog_communicationmeans', 'frequency', self.gf('django.db.models.fields.CharField')(max_length=50, null='True'))

        # Changing field 'CommunicationMeans.purpose'
        db.alter_column('cog_communicationmeans', 'purpose', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    def backwards(self, orm):
        # Deleting field 'CommunicationMeans.participationDetails'
        db.delete_column('cog_communicationmeans', 'participationDetails')


        # Changing field 'CommunicationMeans.membership'
        db.alter_column('cog_communicationmeans', 'membership', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'CommunicationMeans.frequency'
        db.alter_column('cog_communicationmeans', 'frequency', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'CommunicationMeans.purpose'
        db.alter_column('cog_communicationmeans', 'purpose', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
    models = {
        'auth.group': {
