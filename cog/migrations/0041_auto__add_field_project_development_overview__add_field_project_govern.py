...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.governance_overview'
        db.add_column('cog_project', 'governance_overview', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.governance_overview'
        db.delete_column('cog_project', 'governance_overview')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 12, 27, 40, 166364)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 12, 27, 40, 166254)'}),
        ...
        'cog.project': {
            ...
            'description': ('django.db.models.fields.TextField', [], {}),
            'development_overview': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'external_homepage': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'governance_overview': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
