...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectTab.parent'
        db.add_column('cog_projecttab', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.ProjectTab'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectTab.parent'
        db.delete_column('cog_projecttab', 'parent_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 20, 13, 24, 27, 450481)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 20, 13, 24, 27, 450366)'}),
