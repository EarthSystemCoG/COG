...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_collaborator', (
        ...
        db.send_create_signal('cog', ['Collaborator'])


    def backwards(self, orm):
        
        # Deleting model 'Collaborator'
        db.delete_table('cog_collaborator')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 21, 17, 43, 155551)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 21, 17, 43, 155440)'}),
