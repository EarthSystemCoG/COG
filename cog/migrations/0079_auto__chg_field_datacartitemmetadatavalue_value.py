...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataCartItemMetadataValue.value'
        db.alter_column(u'cog_datacartitemmetadatavalue', 'value', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'DataCartItemMetadataValue.value'
        db.alter_column(u'cog_datacartitemmetadatavalue', 'value', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
