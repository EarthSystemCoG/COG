...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchProfile.replicaSearchFlag'
        db.add_column(u'cog_searchprofile', 'replicaSearchFlag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SearchProfile.latestSearchFlag'
        db.add_column(u'cog_searchprofile', 'latestSearchFlag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SearchProfile.localSearchFlag'
        db.add_column(u'cog_searchprofile', 'localSearchFlag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchProfile.replicaSearchFlag'
        db.delete_column(u'cog_searchprofile', 'replicaSearchFlag')

        # Deleting field 'SearchProfile.latestSearchFlag'
        db.delete_column(u'cog_searchprofile', 'latestSearchFlag')

        # Deleting field 'SearchProfile.localSearchFlag'
        db.delete_column(u'cog_searchprofile', 'localSearchFlag')
