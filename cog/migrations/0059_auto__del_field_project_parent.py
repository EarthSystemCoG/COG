...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cog_project', 'parent_id')

        # Adding M2M table for field parents on 'Project'
        db.create_table('cog_project_parents', (
        ...
        db.create_unique('cog_project_parents', ['from_project_id', 'to_project_id'])


    def backwards(self, orm):
        
        # Adding field 'Project.parent'
        db.add_column('cog_project', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Parent Project', null=True, to=orm['cog.Project'], blank=True), keep_default=False)

        # Removing M2M table for field parents on 'Project'
        db.delete_table('cog_project_parents')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 5, 21, 38, 204372)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 5, 21, 38, 204263)'}),
