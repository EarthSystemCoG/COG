...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.software_features'
        db.add_column(u'cog_project', 'software_features',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Project.software_system_requirements'
        db.add_column(u'cog_project', 'software_system_requirements',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.software_supported_platforms'
        db.add_column(u'cog_project', 'software_supported_platforms',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Bookmark.notes'
        db.alter_column(u'cog_bookmark', 'notes_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Post'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Post.parent'
        db.alter_column(u'cog_post', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Post'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Post.author'
        db.alter_column(u'cog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Post.topic'
        db.alter_column(u'cog_post', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Topic'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'Project.software_features'
        db.delete_column(u'cog_project', 'software_features')

        # Deleting field 'Project.software_system_requirements'
        db.delete_column(u'cog_project', 'software_system_requirements')

        # Deleting field 'Project.software_supported_platforms'
        db.delete_column(u'cog_project', 'software_supported_platforms')


        # Changing field 'Bookmark.notes'
        db.alter_column(u'cog_bookmark', 'notes_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Post'], null=True))

        # Changing field 'Post.parent'
        db.alter_column(u'cog_post', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Post'], null=True))

        # Changing field 'Post.author'
        db.alter_column(u'cog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Post.topic'
        db.alter_column(u'cog_post', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Topic'], null=True))
    ...
    models = {
        ...
        'cog.doc': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'documents'", 'to': u"orm['auth.User']"}),
        ...
        'cog.project': {
            ...
            'software_features': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'software_supported_platforms': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'software_system_requirements': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
