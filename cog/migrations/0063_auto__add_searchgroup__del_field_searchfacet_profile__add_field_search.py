...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_searchgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.SearchProfile'])),
            ('name', self.gf('django.db.models.fields.CharField')(default='default', max_length=40)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal('cog', ['SearchGroup'])

        # Deleting field 'SearchFacet.profile'
        db.delete_column('cog_searchfacet', 'profile_id')

        # Adding field 'SearchFacet.group'
        db.add_column('cog_searchfacet', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.SearchGroup'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SearchGroup'
        db.delete_table('cog_searchgroup')

        # User chose to not deal with backwards NULL issues for 'SearchFacet.profile'
        raise RuntimeError("Cannot reverse this migration. 'SearchFacet.profile' and its values cannot be restored.")

        # Deleting field 'SearchFacet.group'
        db.delete_column('cog_searchfacet', 'group_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 7, 5, 51, 635128)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 7, 5, 51, 635009)'}),
        ...
        'cog.searchfacet': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cog.SearchGroup']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
