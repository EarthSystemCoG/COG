...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_fundingsource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Project'])),
        ))
        db.send_create_signal('cog', ['FundingSource'])

        # Adding model 'Organization'
        db.create_table('cog_organization', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Project'])),
        ))
        db.send_create_signal('cog', ['Organization'])

        # Adding field 'Project.mission'
        db.add_column('cog_project', 'mission', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Project.vision'
        db.add_column('cog_project', 'vision', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Project.values'
        db.add_column('cog_project', 'values', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Project.history'
        db.add_column('cog_project', 'history', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'FundingSource'
        db.delete_table('cog_fundingsource')

        # Deleting model 'Organization'
        db.delete_table('cog_organization')

        # Deleting field 'Project.mission'
        db.delete_column('cog_project', 'mission')

        # Deleting field 'Project.vision'
        db.delete_column('cog_project', 'vision')

        # Deleting field 'Project.values'
        db.delete_column('cog_project', 'values')

        # Deleting field 'Project.history'
        db.delete_column('cog_project', 'history')
