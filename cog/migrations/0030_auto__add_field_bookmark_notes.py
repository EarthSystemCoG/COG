...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bookmark.notes'
        db.add_column('cog_bookmark', 'notes',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Post'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bookmark.notes'
        db.delete_column('cog_bookmark', 'notes_id')
