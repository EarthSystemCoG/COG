...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForumThread.update_date'
        db.alter_column(u'cog_forumthread', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ForumThread.update_date'
        db.alter_column(u'cog_forumthread', 'update_date', self.gf('django.db.models.fields.DateTimeField')())
