...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FundingSource.url'
        db.add_column('cog_fundingsource', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'FundingSource.image'
        db.add_column('cog_fundingsource', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Organization.url'
        db.add_column('cog_organization', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Organization.image'
        db.add_column('cog_organization', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FundingSource.url'
        db.delete_column('cog_fundingsource', 'url')

        # Deleting field 'FundingSource.image'
        db.delete_column('cog_fundingsource', 'image')

        # Deleting field 'Organization.url'
        db.delete_column('cog_organization', 'url')

        # Deleting field 'Organization.image'
        db.delete_column('cog_organization', 'image')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 10, 28, 48, 258978)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 10, 28, 48, 258867)'}),
