...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cog', ['Lock'])

        # Adding unique constraint on 'Lock', fields ['object_type', 'object_id']
        db.create_unique('cog_lock', ['object_type', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Lock', fields ['object_type', 'object_id']
        db.delete_unique('cog_lock', ['object_type', 'object_id'])

        # Deleting model 'Lock'
        db.delete_table('cog_lock')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 18, 11, 37, 7, 409248)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 18, 11, 37, 7, 409134)'}),
