...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_projecttag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal('cog', ['ProjectTag'])

        # Adding M2M table for field tags on 'Project'
        db.create_table('cog_project_tags', (
        ...
        db.create_unique('cog_project_tags', ['project_id', 'projecttag_id'])


    def backwards(self, orm):
        
        # Deleting model 'ProjectTag'
        db.delete_table('cog_projecttag')

        # Removing M2M table for field tags on 'Project'
        db.delete_table('cog_project_tags')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 8, 14, 21, 30, 40086)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 8, 14, 21, 30, 39973)'}),
        ...
        'cog.project': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['cog.ProjectTag']", 'null': 'True', 'blank': 'True'}),
