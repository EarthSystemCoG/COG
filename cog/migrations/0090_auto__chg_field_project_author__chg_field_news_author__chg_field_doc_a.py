...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.author'
        db.alter_column(u'cog_project', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))

        # Changing field 'News.author'
        db.alter_column(u'cog_news', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Doc.author'
        db.alter_column(u'cog_doc', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Project.author'
        db.alter_column(u'cog_project', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # User chose to not deal with backwards NULL issues for 'News.author'
        raise RuntimeError("Cannot reverse this migration. 'News.author' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'News.author'
        db.alter_column(u'cog_news', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'Doc.author'
        raise RuntimeError("Cannot reverse this migration. 'Doc.author' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Doc.author'
        db.alter_column(u'cog_doc', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
