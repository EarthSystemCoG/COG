...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ManagementBodyPurpose'
        db.create_table('cog_managementbodypurpose', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('purpose', self.gf('django.db.models.fields.CharField')(default='Other', max_length=50)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(default='Strategic', max_length=50)),
        ))
        db.send_create_signal('cog', ['ManagementBodyPurpose'])

        # Deleting field 'ManagementBody.purpose'
        db.delete_column('cog_managementbody', 'purpose')

        # Adding M2M table for field purposes on 'ManagementBody'
        db.create_table('cog_managementbody_purposes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('managementbody', models.ForeignKey(orm['cog.managementbody'], null=False)),
            ('managementbodypurpose', models.ForeignKey(orm['cog.managementbodypurpose'], null=False))
        ))
        db.create_unique('cog_managementbody_purposes', ['managementbody_id', 'managementbodypurpose_id'])


    def backwards(self, orm):
        
        # Deleting model 'ManagementBodyPurpose'
        db.delete_table('cog_managementbodypurpose')

        # Adding field 'ManagementBody.purpose'
        db.add_column('cog_managementbody', 'purpose', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Removing M2M table for field purposes on 'ManagementBody'
        db.delete_table('cog_managementbody_purposes')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 14, 30, 2, 442605)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 14, 30, 2, 442493)'}),
        ...
        'cog.managementbody': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cog.Project']"}),
            'purposes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cog.ManagementBodyPurpose']", 'symmetrical': 'False'}),
