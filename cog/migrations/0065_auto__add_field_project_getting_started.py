...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.getting_started'
        db.add_column(u'cog_project', 'getting_started',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.getting_started'
        db.delete_column(u'cog_project', 'getting_started')
    ...
    models = {
        ...
        'cog.project': {
            ...
            'getting_started': ('django.db.models.fields.TextField', [], {'null': 'True'}),
