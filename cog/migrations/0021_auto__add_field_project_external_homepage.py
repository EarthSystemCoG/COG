...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.external_homepage'
        db.add_column('cog_project', 'external_homepage', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.external_homepage'
        db.delete_column('cog_project', 'external_homepage')
