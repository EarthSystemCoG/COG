...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_membershiprequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('cog', ['MembershipRequest'])

        # Adding unique constraint on 'MembershipRequest', fields ['user', 'group']
        db.create_unique('cog_membershiprequest', ['user_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MembershipRequest', fields ['user', 'group']
        db.delete_unique('cog_membershiprequest', ['user_id', 'group_id'])

        # Deleting model 'MembershipRequest'
        db.delete_table('cog_membershiprequest')
