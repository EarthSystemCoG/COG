...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.reserchKeywords'
        db.delete_column('cog_userprofile', 'reserchKeywords')

        # Deleting field 'UserProfile.reserchInterests'
        db.delete_column('cog_userprofile', 'reserchInterests')

        # Adding field 'UserProfile.researchInterests'
        db.add_column('cog_userprofile', 'researchInterests', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.researchKeywords'
        db.add_column('cog_userprofile', 'researchKeywords', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.reserchKeywords'
        db.add_column('cog_userprofile', 'reserchKeywords', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.reserchInterests'
        db.add_column('cog_userprofile', 'reserchInterests', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.researchInterests'
        db.delete_column('cog_userprofile', 'researchInterests')

        # Deleting field 'UserProfile.researchKeywords'
        db.delete_column('cog_userprofile', 'researchKeywords')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 9, 23, 4, 4, 429488)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 9, 23, 4, 4, 429377)'}),
        ...
        'cog.userprofile': {
            ...
            'institution': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'private': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'researchInterests': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'researchKeywords': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
