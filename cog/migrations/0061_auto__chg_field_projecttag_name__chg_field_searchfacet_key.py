...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectTag.name'
        db.alter_column('cog_projecttag', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

        # Changing field 'SearchFacet.key'
        db.alter_column('cog_searchfacet', 'key', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'ProjectTag.name'
        db.alter_column('cog_projecttag', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True))

        # Changing field 'SearchFacet.key'
        db.alter_column('cog_searchfacet', 'key', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 5, 7, 12, 8, 280018)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 5, 7, 12, 8, 279904)'}),
