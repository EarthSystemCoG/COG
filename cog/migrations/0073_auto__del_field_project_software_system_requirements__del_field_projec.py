...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.system_requirements'
        db.add_column(u'cog_project', 'system_requirements',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.system_requirements'
        db.delete_column(u'cog_project', 'system_requirements')
