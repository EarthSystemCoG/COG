...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DataCart'
        db.create_table(u'cog_datacart', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='datacart', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('cog', ['DataCart'])

        # Adding model 'DataCartItem'
        db.create_table(u'cog_datacartitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cart', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['cog.DataCart'])),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('cog', ['DataCartItem'])

        # Adding model 'DataCartItemMetadataKey'
        db.create_table(u'cog_datacartitemmetadatakey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='keys', to=orm['cog.DataCartItem'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('cog', ['DataCartItemMetadataKey'])

        # Adding model 'DataCartItemMetadataValue'
        db.create_table(u'cog_datacartitemmetadatavalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.related.ForeignKey')(related_name='values', to=orm['cog.DataCartItemMetadataKey'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('cog', ['DataCartItemMetadataValue'])


    def backwards(self, orm):
        # Deleting model 'DataCart'
        db.delete_table(u'cog_datacart')

        # Deleting model 'DataCartItem'
        db.delete_table(u'cog_datacartitem')

        # Deleting model 'DataCartItemMetadataKey'
        db.delete_table(u'cog_datacartitemmetadatakey')

        # Deleting model 'DataCartItemMetadataValue'
        db.delete_table(u'cog_datacartitemmetadatavalue')
