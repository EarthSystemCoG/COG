...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.projectContacts'
        db.add_column(u'cog_project', 'projectContacts',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.technicalSupport'
        db.add_column(u'cog_project', 'technicalSupport',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.meetingSupport'
        db.add_column(u'cog_project', 'meetingSupport',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.getInvolved'
        db.add_column(u'cog_project', 'getInvolved',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Folder', fields ['project', 'name']
        db.create_unique(u'cog_folder', ['project_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Folder', fields ['project', 'name']
        db.delete_unique(u'cog_folder', ['project_id', 'name'])

        # Deleting field 'Project.projectContacts'
        db.delete_column(u'cog_project', 'projectContacts')

        # Deleting field 'Project.technicalSupport'
        db.delete_column(u'cog_project', 'technicalSupport')

        # Deleting field 'Project.meetingSupport'
        db.delete_column(u'cog_project', 'meetingSupport')

        # Deleting field 'Project.getInvolved'
        db.delete_column(u'cog_project', 'getInvolved')
    ...
    models = {
        ...
        'cog.project': {
            ...
            'projectContacts': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
