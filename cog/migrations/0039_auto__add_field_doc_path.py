...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Doc.path'
        db.add_column('cog_doc', 'path', self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Doc.path'
        db.delete_column('cog_doc', 'path')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 12, 35, 0, 903045)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 12, 35, 0, 902933)'}),
