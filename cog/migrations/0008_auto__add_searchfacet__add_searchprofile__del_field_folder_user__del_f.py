...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_searchfacet', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.SearchProfile'])),
        ...
        # Adding model 'SearchProfile'
        db.create_table('cog_searchprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cog.Project'], unique=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('constraints', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('cog', ['SearchProfile'])

        # Deleting field 'Folder.user'
        db.delete_column('cog_folder', 'user_id')

        # Deleting field 'Bookmark.type'
        db.delete_column('cog_bookmark', 'type')

        # Adding field 'Bookmark.description'
        db.add_column('cog_bookmark', 'description', self.gf('django.db.models.fields.TextField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Bookmark.order'
        db.add_column('cog_bookmark', 'order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SearchProfile'
        db.delete_table('cog_searchprofile')

        # User chose to not deal with backwards NULL issues for 'Folder.user'
        raise RuntimeError("Cannot reverse this migration. 'Folder.user' and its values cannot be restored.")

        # Adding field 'Bookmark.type'
        db.add_column('cog_bookmark', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Deleting field 'Bookmark.description'
        db.delete_column('cog_bookmark', 'description')

        # Deleting field 'Bookmark.order'
        db.delete_column('cog_bookmark', 'order')
