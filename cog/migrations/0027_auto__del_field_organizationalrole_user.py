...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrganizationalRole.user'
        db.delete_column('cog_organizationalrole', 'user_id')

    def backwards(self, orm):
        # Adding field 'OrganizationalRole.user'
        db.add_column('cog_organizationalrole', 'user',
