...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchProfile.description'
        db.add_column(u'cog_searchprofile', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchProfile.description'
        db.delete_column(u'cog_searchprofile', 'description')
    ...
    models = {
        ...
        'cog.project': {
            ...
            'future_work': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
