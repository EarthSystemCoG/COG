...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationalRole'
        db.create_table('cog_organizationalrole', (
        ...
        db.send_create_signal('cog', ['OrganizationalRole'])

    def backwards(self, orm):
        # Deleting model 'OrganizationalRole'
        db.delete_table('cog_organizationalrole')
