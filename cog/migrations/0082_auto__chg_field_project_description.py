...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cog_project', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.description'
        db.alter_column(u'cog_project', 'description', self.gf('django.db.models.fields.TextField')())
