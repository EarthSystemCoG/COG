...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.label'
        db.alter_column('cog_post', 'label', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # Changing field 'Post.label'
        db.alter_column('cog_post', 'label', self.gf('django.db.models.fields.CharField')(max_length=22, null=True))
