...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_password_update'
        db.add_column(u'cog_userprofile', 'last_password_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_password_update'
        db.delete_column(u'cog_userprofile', 'last_password_update')
