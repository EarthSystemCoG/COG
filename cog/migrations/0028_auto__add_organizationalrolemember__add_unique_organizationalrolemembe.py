...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationalRoleMember'
        db.create_table('cog_organizationalrolemember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('organizationalRole', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.OrganizationalRole'])),
        ))
        db.send_create_signal('cog', ['OrganizationalRoleMember'])

        # Adding unique constraint on 'OrganizationalRoleMember', fields ['user', 'organizationalRole']
        db.create_unique('cog_organizationalrolemember', ['user_id', 'organizationalRole_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'OrganizationalRoleMember', fields ['user', 'organizationalRole']
        db.delete_unique('cog_organizationalrolemember', ['user_id', 'organizationalRole_id'])

        # Deleting model 'OrganizationalRoleMember'
        db.delete_table('cog_organizationalrolemember')
