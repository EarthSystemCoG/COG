...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cog_project', 'long_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=120))

    def backwards(self, orm):

        # Changing field 'Project.long_name'
        db.alter_column(u'cog_project', 'long_name', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
