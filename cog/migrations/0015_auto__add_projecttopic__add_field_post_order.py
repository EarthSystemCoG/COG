...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_projecttopic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Topic'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.Project'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('cog', ['ProjectTopic'])

        # Adding field 'Post.order'
        db.add_column('cog_post', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ProjectTopic'
        db.delete_table('cog_projecttopic')

        # Deleting field 'Post.order'
        db.delete_column('cog_post', 'order')
    ...
    models = {
        ...
        'cog.project': {
            ...
            'topics': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cog.Topic']", 'through': "orm['cog.ProjectTopic']", 'symmetrical': 'False'})
        },
        'cog.projecttab': {
