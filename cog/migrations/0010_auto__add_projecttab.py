...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectTab'
        db.create_table('cog_projecttab', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tabs', to=orm['cog.Project'])),
        ...
        db.send_create_signal('cog', ['ProjectTab'])


    def backwards(self, orm):
        
        # Deleting model 'ProjectTab'
        db.delete_table('cog_projecttab')
