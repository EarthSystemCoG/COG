...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectImpact'
        db.create_table(u'cog_projectimpact', (
        ...
        db.send_create_signal('cog', ['ProjectImpact'])


    def backwards(self, orm):
        # Deleting model 'ProjectImpact'
        db.delete_table(u'cog_projectimpact')
