...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationalRole.category'
        db.add_column('cog_organizationalrole', 'category',
                      self.gf('django.db.models.fields.CharField')(default='Member', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationalRole.category'
        db.delete_column('cog_organizationalrole', 'category')
