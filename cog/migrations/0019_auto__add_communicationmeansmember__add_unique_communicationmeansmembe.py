...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommunicationMeansMember'
        db.create_table('cog_communicationmeansmember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('communicationMeans', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.CommunicationMeans'])),
        ))
        db.send_create_signal('cog', ['CommunicationMeansMember'])

        # Adding unique constraint on 'CommunicationMeansMember', fields ['user', 'communicationMeans']
        db.create_unique('cog_communicationmeansmember', ['user_id', 'communicationMeans_id'])

        # Adding model 'CommunicationMeans'
        db.create_table('cog_communicationmeans', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('cog', ['CommunicationMeans'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CommunicationMeansMember', fields ['user', 'communicationMeans']
        db.delete_unique('cog_communicationmeansmember', ['user_id', 'communicationMeans_id'])

        # Deleting model 'CommunicationMeansMember'
        db.delete_table('cog_communicationmeansmember')

        # Deleting model 'CommunicationMeans'
        db.delete_table('cog_communicationmeans')
