...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GovernanceProcesses'
        db.delete_table('cog_governanceprocesses')

        # Adding field 'Project.taskPrioritizationStrategy'
        db.add_column('cog_project', 'taskPrioritizationStrategy',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.requirementsIdentificationProcess'
        db.add_column('cog_project', 'requirementsIdentificationProcess',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding model 'GovernanceProcesses'
        db.create_table('cog_governanceprocesses', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cog.Project'], unique=True)),
            ('requirementsIdentificationProcess', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('taskPrioritizationStrategy', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('cog', ['GovernanceProcesses'])

        # Deleting field 'Project.taskPrioritizationStrategy'
        db.delete_column('cog_project', 'taskPrioritizationStrategy')

        # Deleting field 'Project.requirementsIdentificationProcess'
        db.delete_column('cog_project', 'requirementsIdentificationProcess')
