...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LoggedEvent.sender'
        db.alter_column(u'cog_loggedevent', 'sender', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Doc.file'
        db.alter_column(u'cog_doc', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'LoggedEvent.sender'
        db.alter_column(u'cog_loggedevent', 'sender', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Doc.file'
        db.alter_column(u'cog_doc', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
