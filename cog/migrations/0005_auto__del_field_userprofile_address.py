...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cog_userprofile', 'address')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.address'
        db.add_column('cog_userprofile', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True), keep_default=False)
