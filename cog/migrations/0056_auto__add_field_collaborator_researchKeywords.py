...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collaborator.researchKeywords'
        db.add_column('cog_collaborator', 'researchKeywords', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Collaborator.researchKeywords'
        db.delete_column('cog_collaborator', 'researchKeywords')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 14, 18, 40, 231560)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 14, 18, 40, 231445)'}),
