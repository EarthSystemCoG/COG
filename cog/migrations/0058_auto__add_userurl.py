...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cog_userurl', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=1000)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.UserProfile'])),
        ))
        db.send_create_signal('cog', ['UserUrl'])


    def backwards(self, orm):
        
        # Deleting model 'UserUrl'
        db.delete_table('cog_userurl')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 18, 5, 56, 38, 2566)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 18, 5, 56, 38, 2455)'}),
