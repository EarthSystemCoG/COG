...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cog_datacartitemmetadatakey', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.DataCartItem'])),
        ...
        db.create_table(u'cog_datacartitemmetadatavalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cog.DataCartItemMetadataKey'])),
    ...
    models = {
        ...
        'cog.datacartitemmetadatakey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cog.DataCartItem']"}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'cog.datacartitemmetadatavalue': {
            'Meta': {'object_name': 'DataCartItemMetadataValue'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cog.DataCartItemMetadataKey']"}),
