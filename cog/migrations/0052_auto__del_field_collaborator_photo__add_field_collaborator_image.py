...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Collaborator.photo'
        db.delete_column('cog_collaborator', 'photo')

        # Adding field 'Collaborator.image'
        db.add_column('cog_collaborator', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Collaborator.photo'
        db.add_column('cog_collaborator', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Collaborator.image'
        db.delete_column('cog_collaborator', 'image')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 14, 58, 47, 10704)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 14, 58, 47, 10593)'}),
