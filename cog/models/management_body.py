...
from cog.models.constants import (APPLICATION_LABEL, 
                                  MANAGEMENT_BODY_CATEGORY_STRATEGIC, MANAGEMENT_BODY_CATEGORY_OPERATIONAL, MANAGEMENT_BODY_CV,
                                  MANAGEMENT_BODY_CATEGORIES_CV, MANAGEMENT_BODY_CATEGORY_STRATEGIC, MANAGEMENT_BODY_CATEGORY_OPERATIONAL, 
                                  STRATEGIC_MANAGEMENT_BODY_DICT, OPERATIONAL_MANAGEMENT_BODY_DICT, MANAGEMENT_BODY_DICT)
from cog.models.project import Project

class ManagementBodyPurpose(models.Model):
    purpose = models.CharField(max_length=50, null=False, default='Other', choices=MANAGEMENT_BODY_CV, verbose_name='Purpose/Role', help_text='Type of organizational body (choose from controlled vocabulary).')
    order = models.IntegerField(blank=True, default=0)
    category = models.CharField(max_length=50, null=False, default=MANAGEMENT_BODY_CATEGORY_STRATEGIC, choices=MANAGEMENT_BODY_CATEGORIES_CV, verbose_name='Category', help_text='Strategic or Operational management body purpose.')
...
class ManagementBody(models.Model):
    ...
    title = models.CharField(max_length=200, blank=False, verbose_name='Title',  help_text='String used to succinctly describe an organizational body.')
    description = models.TextField(blank=False, verbose_name='Description', help_text='A short description providing extra information about organizational body.')
    termsOfReference = models.TextField(blank=True, verbose_name='Terms of Reference', help_text='A  description of the duties and responsibilities of the organizational body.')
    purposes = models.ManyToManyField(ManagementBodyPurpose, null=True, blank=True)
    other = models.CharField(max_length=200, null=True, blank=True, verbose_name='Other Purpose',  help_text='Specify any other purpose(s) not included in the controlled vocabulary.')
    category = models.CharField(max_length=50, blank=True, null=False, default=MANAGEMENT_BODY_CATEGORY_STRATEGIC, choices=MANAGEMENT_BODY_CATEGORIES_CV, verbose_name='Category', help_text='Strategic or Operational management body purpose.')
    project = models.ForeignKey(Project)
 
    def members(self):
        return self.managementbodymember_set.all()
