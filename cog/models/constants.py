...
ORGANIZATIONAL_ROLES_DICT = dict( list(LEAD_ORGANIZATIONAL_ROLES_DICT.items()) + list(MEMBER_ORGANIZATIONAL_ROLES_DICT.items()) )
...
MANAGEMENT_BODY_DICT = dict( list(STRATEGIC_MANAGEMENT_BODY_DICT.items()) + list(OPERATIONAL_MANAGEMENT_BODY_DICT.items()) )
