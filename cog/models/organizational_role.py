...
class OrganizationalRole(models.Model):
    ...
    type = models.CharField(max_length=50, blank=False, null=False, default='', choices=ORGANIZATIONAL_ROLE_CV, verbose_name='Type', help_text='Type of organizational role (choose from controlled vocabulary).')
