...
TABS = {"ABOUTUS": "aboutus", "MISSION": "mission",
        ...
        "RESOURCES": "resources",
        "DEVELOPERS": "developers", "DEV_DOCS": externalUrlManager.getConf(type=EXTERNAL_URL_TYPES["DEV_DOCS"]).suburl,
                                    "REPOSITORIES": externalUrlManager.getConf(type=EXTERNAL_URL_TYPES["REPOSITORY"]).suburl,
...
PROJECT_PAGES = (
    ...
    [("Developers", "%s/" % TABS["DEVELOPERS"]), ("Dev Docs", "%s/" % TABS["DEV_DOCS"]),
                                                 ("Repositories", "%s/" % TABS["REPOSITORIES"]),
...
# 'roadmap/': [], 
# 'contactus/': [], 
# 'aboutus/': ['aboutus/mission/', 'aboutus/vision/', 'aboutus/values/', 'aboutus/partners/', 'aboutus/sponsors/',
# 'aboutus/people/'],
#'code/': []
# }
NAVMAP = {}
...
#   'aboutus/partners/': 'aboutus/', 'governance/': 'governance/', 'aboutus/mission/': 'aboutus/',
# 'bookmarks/list/<project>/': 'bookmarks/list/<project>/', 'contactus/': 'contactus/', 'trackers/': 'trackers/',
# 'aboutus/values/': 'aboutus/', 'aboutus/sponsors/': 'aboutus/', 'roadmap/': 'roadmap/', 'support/': 'support/',
# 'aboutus/': 'aboutus/',
#   'code/': 'code/'
# }
INVNAVMAP = {}
