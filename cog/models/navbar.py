...
from external_url_conf import EXTERNAL_URL_SUBURL_MAP
...
TABS = { "ABOUTUS":"aboutus", "MISSION":"mission", 
                              ...
                              "SPONSORS":"sponsors", 
                              "PEOPLE":"people",
         "SOFTWARE":"software", "DOWNLOAD":EXTERNAL_URL_SUBURL_MAP["download"].suburl, 
                                "ADMIN_GUIDE":EXTERNAL_URL_SUBURL_MAP["admin_guide"].suburl,
         "USERS":"users", "FAQ":EXTERNAL_URL_SUBURL_MAP["faq"].suburl, 
                          "USER_GUIDE":EXTERNAL_URL_SUBURL_MAP["user_guide"].suburl, 
                          "CODE_EXAMPLES":EXTERNAL_URL_SUBURL_MAP["code_examples"].suburl,
         "BOOKMARKS":"bookmarks",
         "DEVELOPERS":"developers", "REPOSITORIES":EXTERNAL_URL_SUBURL_MAP["repositories"].suburl, 
                                    "TRACKERS":EXTERNAL_URL_SUBURL_MAP["trackers"].suburl, 
                                    "DEVELOPER_GUIDE":EXTERNAL_URL_SUBURL_MAP["developer_guide"].suburl, 
                                    "DESIGN_DOCS":EXTERNAL_URL_SUBURL_MAP["design_docs"].suburl, 
                                    "TESTING":EXTERNAL_URL_SUBURL_MAP["testing"].suburl, 
                                    "USECASES":EXTERNAL_URL_SUBURL_MAP["usecases"].suburl, 
                                    "CHECKLIST":EXTERNAL_URL_SUBURL_MAP["checklist"].suburl,
         "PLANS":"plans", "ROADMAP":"roadmap", 
                          "RELEASE_SCHEDULES":EXTERNAL_URL_SUBURL_MAP["release_schedules"].suburl,
         "GOVERNANCE":"governance", "BODIES":"bodies",
                                    "ROLES":"roles", 
                                    "COMMUNICATION":"communication", 
                                    "PROCESSES":"processes", 
                                    "POLICIES":EXTERNAL_URL_SUBURL_MAP["policies"].suburl,
                                    "MINUTES":EXTERNAL_URL_SUBURL_MAP["minutes"].suburl,
                                    "METRICS":EXTERNAL_URL_SUBURL_MAP["metrics"].suburl,
