...
from external_url_page import EXTERNAL_URL_PAGES
...
TABS = { "ABOUTUS":"aboutus", "MISSION":"mission", 
                              ...
                              "SPONSORS":"sponsors", 
                              "PEOPLE":"people",
         "SOFTWARE":"software", "DOWNLOAD":EXTERNAL_URL_PAGES["URL_TYPE_DOWNLOAD"].suburl, 
                                "ADMIN_GUIDE":EXTERNAL_URL_PAGES["URL_TYPE_ADMIN_GUIDE"].suburl,
         "USERS":"users", "FAQ":EXTERNAL_URL_PAGES["URL_TYPE_FAQ"].suburl, 
                          "USER_GUIDE":EXTERNAL_URL_PAGES["URL_TYPE_USER_GUIDE"].suburl, 
                          "CODE_EXAMPLES":EXTERNAL_URL_PAGES["URL_TYPE_CODE_EXAMPLE"].suburl,
         "BOOKMARKS":"bookmarks",
         "DEVELOPERS":"developers", "REPOSITORIES":EXTERNAL_URL_PAGES["URL_TYPE_REPOSITORY"].suburl, 
                                    "TRACKERS":EXTERNAL_URL_PAGES["URL_TYPE_TRACKER"].suburl, 
                                    "DEVELOPER_GUIDE":EXTERNAL_URL_PAGES["URL_TYPE_DEVELOPER_GUIDE"].suburl, 
                                    "DESIGN_DOCS":EXTERNAL_URL_PAGES["URL_TYPE_DESIGN_DOC"].suburl, 
                                    "TESTING":EXTERNAL_URL_PAGES["URL_TYPE_TESTING"].suburl, 
                                    "USECASES":EXTERNAL_URL_PAGES["URL_TYPE_USECASE"].suburl, 
                                    "CHECKLIST":EXTERNAL_URL_PAGES["URL_TYPE_CHECKLIST"].suburl,
         "ROADMAP":"roadmap",
