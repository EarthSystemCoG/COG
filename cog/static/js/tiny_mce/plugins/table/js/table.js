...
function init() {
	// add some custom styles to display in the dialog box
        settings = tinyMCE.settings;       
        settings["table_styles"] =  "color even rows=even-color;color odd rows (default)=odd-color;do not color rows=no-color;" + settings["table_styles"];
