...
try:
    ...
    DEFAULT_URL_TINYMCE = "site_media/js/tiny_mce/"
...
#URL_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_URL_FILEBROWSER_MEDIA", "http://localhost:8000/site_media/filebrowser/")
